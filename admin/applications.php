<?php 
    ...
    $query = "SELECT * FROM applications $whereClause ORDER BY id DESC LIMIT $offset, $limit";
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <p><strong>Application Type:</strong> <?php echo htmlspecialchars($row['application_type']); ?></p>
